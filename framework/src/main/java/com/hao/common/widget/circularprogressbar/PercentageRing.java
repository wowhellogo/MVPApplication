...
public class PercentageRing extends View{
    ...
    public PercentageRing(Context context, AttributeSet attrs) {
        ...
        //外圆环的颜色  默认为深紫色
        mRingColor = typedArray.getColor(R.styleable.PercentageRing_circleRingColor, 0xff6950a1);
        //中间圆的半径 默认为60
        mRadius = typedArray.getInt(R.styleable.PercentageRing_radius, 60);
        //字体颜色 默认为白色
        mTextColor = typedArray.getColor(R.styleable.PercentageRing_circleTextColor, 0xffffffff);
