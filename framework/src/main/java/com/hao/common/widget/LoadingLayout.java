...
public class LoadingLayout extends FrameLayout {
    ...
    private static int reloadBtnId;
    ...
    private void build() {
        ...
        loadingPage.setBackgroundColor(getColor(mContext, backgroundColor));
        errorPage.setBackgroundColor(getColor(mContext, backgroundColor));
        emptyPage.setBackgroundColor(getColor(mContext, backgroundColor));
        networkPage.setBackgroundColor(getColor(mContext, backgroundColor));
        ...
        errorText.setTextColor(getColor(mContext, tipTextColor));
        emptyText.setTextColor(getColor(mContext, tipTextColor));
        networkText.setTextColor(getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(getColor(mContext, buttonTextColor));
