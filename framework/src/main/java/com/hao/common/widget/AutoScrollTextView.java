...
public class AutoScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public AutoScrollTextView(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.autoScrollHeight_textSize, 24);
        mPadding = a.getDimensionPixelSize(R.styleable.autoScrollHeight_padding, 20);
        scrollDuration = a.getInteger(R.styleable.autoScrollHeight_scrollDuration, 3000);
        animDuration = a.getInteger(R.styleable.autoScrollHeight_animsDuration, 300);
