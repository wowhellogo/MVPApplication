package com.hao.common.widget.quicksidebar;
...
import com.hao.common.widget.quicksidebar.listener.OnQuickSideBarTouchListener;
...
public class QuickSideBarView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mHeight = measureResult(heightMeasureSpec) - mPaddingTop;
        mWidth = measureResult(widthMeasureSpec);
