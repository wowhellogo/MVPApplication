...
public abstract class BaseAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final BaseAdapterViewHolder viewHolder = BaseAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
     ...
     * @param helper
     */
    protected void setItemChildListener(BaseViewHolderHelper helper) {
    }
